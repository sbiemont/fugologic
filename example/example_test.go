...
func TestExample(t *testing.T) {
	...
	//          |  + |  0 |  0 |  - | -- | -- |
	//          | ++ |  - |  - | -- | -- | -- |
	bld.If(fsDiff[0]).And(fsDt[0]).Then([]fuzzy.IDSet{fsForce[4]})
	bld.If(fsDiff[0]).And(fsDt[1]).Then([]fuzzy.IDSet{fsForce[4]})
	bld.If(fsDiff[0]).And(fsDt[2]).Then([]fuzzy.IDSet{fsForce[4]})
	bld.If(fsDiff[0]).And(fsDt[3]).Then([]fuzzy.IDSet{fsForce[3]})
	bld.If(fsDiff[0]).And(fsDt[4]).Then([]fuzzy.IDSet{fsForce[3]})

	bld.If(fsDiff[1]).And(fsDt[0]).Then([]fuzzy.IDSet{fsForce[4]})
	bld.If(fsDiff[1]).And(fsDt[1]).Then([]fuzzy.IDSet{fsForce[4]})
	bld.If(fsDiff[1]).And(fsDt[2]).Then([]fuzzy.IDSet{fsForce[3]})
	bld.If(fsDiff[1]).And(fsDt[3]).Then([]fuzzy.IDSet{fsForce[2]})
	bld.If(fsDiff[1]).And(fsDt[4]).Then([]fuzzy.IDSet{fsForce[2]})

	bld.If(fsDiff[2]).And(fsDt[0]).Then([]fuzzy.IDSet{fsForce[3]})
	bld.If(fsDiff[2]).And(fsDt[1]).Then([]fuzzy.IDSet{fsForce[3]})
	bld.If(fsDiff[2]).And(fsDt[2]).Then([]fuzzy.IDSet{fsForce[2]})
	bld.If(fsDiff[2]).And(fsDt[3]).Then([]fuzzy.IDSet{fsForce[1]})
	bld.If(fsDiff[2]).And(fsDt[4]).Then([]fuzzy.IDSet{fsForce[1]})

	bld.If(fsDiff[3]).And(fsDt[0]).Then([]fuzzy.IDSet{fsForce[2]})
	bld.If(fsDiff[3]).And(fsDt[1]).Then([]fuzzy.IDSet{fsForce[2]})
	bld.If(fsDiff[3]).And(fsDt[2]).Then([]fuzzy.IDSet{fsForce[1]})
	bld.If(fsDiff[3]).And(fsDt[3]).Then([]fuzzy.IDSet{fsForce[0]})
	bld.If(fsDiff[3]).And(fsDt[4]).Then([]fuzzy.IDSet{fsForce[0]})

	bld.If(fsDiff[4]).And(fsDt[0]).Then([]fuzzy.IDSet{fsForce[1]})
	bld.If(fsDiff[4]).And(fsDt[1]).Then([]fuzzy.IDSet{fsForce[1]})
	bld.If(fsDiff[4]).And(fsDt[2]).Then([]fuzzy.IDSet{fsForce[0]})
	bld.If(fsDiff[4]).And(fsDt[3]).Then([]fuzzy.IDSet{fsForce[0]})
	bld.If(fsDiff[4]).And(fsDt[4]).Then([]fuzzy.IDSet{fsForce[0]})
