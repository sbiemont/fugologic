...
func TestSystem(t *testing.T) {
	...
	// A and B => C
	rulesEng1 := []Rule{NewRule(NewExpression([]Premise{fsA1, fsB1}, ConnectorAnd), ImplicationProd, []IDSet{fsC1})}
	// D => E, F
	rulesEng2 := []Rule{NewRule(fsD1, ImplicationProd, []IDSet{fsE1, fsF1})}
	// C and E => G
	rulesEng3 := []Rule{NewRule(NewExpression([]Premise{fsC1, fsE1}, ConnectorAnd), ImplicationProd, []IDSet{fsG1})}
